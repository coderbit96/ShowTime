...
export function VenueCard({ venue }: VenueCardProps) {
  return (
    <CardHover className="w-[244px] shrink-0 snap-start sm:w-[268px]">
      <article className="premium-card group overflow-hidden rounded-md">
        <div className="relative aspect-[16/9] overflow-hidden bg-surface-muted">
          <Image
            src={venue.image}
            alt={venue.name + ", " + venue.city}
            fill
            sizes="(max-width: 640px) 244px, 268px"
